...
export const ingredientGuides: IngredientGuide[] = [
  {
    ...
    choose: ['Privilégier des tiges de citronnelle fermes et non desséchées.', 'Choisir galanga et curcuma frais, fermes et sans zones molles.', 'Pour le combava, utiliser très peu de zeste et éviter le blanc amer.'],
    keep: ['Conserver 2 à 3 jours au réfrigérateur dans un contenant hermétique.', 'Congeler en petites portions pour disposer d’une base prête à cuisiner.', 'Éviter de le laisser longtemps à l’air : les parfums les plus volatils disparaissent vite.'],
    pairings: ['Poisson blanc', 'Poulet', 'Lait de coco', 'Basilic asiatique', 'Poivre', 'Légumes croquants'],
    mistakes: ['Une pâte trop liquide.', 'Des morceaux de citronnelle trop gros.', 'Une cuisson très longue avant d’ajouter les autres ingrédients.'],
  ...
  },
  {
    ...
    choose: ['Chercher une origine clairement indiquée et un emballage qui protège de l’humidité.', 'Pour les grains secs, privilégier des grains entiers plutôt qu’une poudre déjà moulue.', 'Le poivre vert frais doit rester ferme et bien coloré.'],
    keep: ['Conserver les grains secs au sec, à l’abri de la lumière et de la chaleur.', 'Moudre uniquement la quantité nécessaire.', 'Le poivre vert frais se conserve au réfrigérateur et doit être utilisé rapidement.'],
    pairings: ['Bœuf', 'Crabe', 'Crevettes', 'Citron vert', 'Ail', 'Sauces courtes'],
    mistakes: ['Le poivre déjà moulu depuis longtemps.', 'Une cuisson prolongée qui écrase les notes florales.', 'Surcharger une sauce au point de masquer l’acidité et le produit principal.'],
  ...
  },
  {
    ...
    choose: ['La pulpe pressée sans trop d’additifs est pratique pour cuisiner.', 'Vérifier la liste d’ingrédients des concentrés : certains sont déjà sucrés ou salés.', 'Une pulpe sombre et souple se dose plus facilement qu’un bloc très sec.'],
    keep: ['Conserver la pulpe bien emballée au réfrigérateur après ouverture.', 'Le liquide dilué se garde seulement quelques jours au frais.', 'Congeler de petites portions si vous n’en utilisez qu’occasionnellement.'],
    pairings: ['Poisson', 'Crevettes', 'Sucre de palme', 'Sauce de poisson', 'Piment', 'Herbes fraîches'],
    mistakes: ['Verser tout le tamarin d’un coup.', 'Utiliser un concentré sucré comme s’il s’agissait de pulpe nature.', 'Chercher une acidité aussi vive que celle du citron.'],
